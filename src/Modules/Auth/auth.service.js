...
export const signup = async (req, res, next) => {
    ...
    const user = await dbService.create({
        model: userModel,
        data: [{ firstName, lastName, email, password: await hash({ plainText: password }), gender, phone: cryptedPhone, confirmEmailOTP: await hash({ plainText: otp }), confirmEmailOTPExpiresAt: otpExpiresAt, shareId }]
    })
